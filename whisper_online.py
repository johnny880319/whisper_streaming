...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None, device_index=0):
        ...
        model = WhisperModel(
            model_size_or_path, device_index=device_index, compute_type="float16", download_root=cache_dir
        )
...
class FasterWhisperWorker:
    ...
    def _comsume_once(self) -> None:
        ...
        try:
            ...
            print(
                f"[Worker {os.getpid()}] WARNING: Reply queue full, RayFasterWhisperASR may have died, dropping result.",
                flush=True,
            )
...
def asr_factory(args, logfile=sys.stderr):
    ...
    if args.vac:
        ...
        online = OnlineASRProcessor(
            asr, tokenizer, logfile=logfile, buffer_trimming=(args.buffer_trimming, args.buffer_trimming_sec)
        )
